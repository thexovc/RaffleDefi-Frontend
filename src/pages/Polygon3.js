...
import { abi, abi1, contractAddresses2,} from "../constants";
...
const Polygon3 = () => {
 ...
 const [states, dispatch] = useReducer(reducer, initialState)
  ...
  const raffleAddress =
    chainId in contractAddresses2 ? contractAddresses2[chainId][0] : null;
  ...
  async function updateUIValues() {
    ...
    const price1 = (Math.round((50/price)*10**18)).toString()
  ...
  return (
    <div className="eth__page">
     ...
     <Details className={states.detailsState} coin='polygon3' />
    <Calendar className={states.calendarState} Name='noDisplay' coin='polygon3' />
    <Transactions className={states.transactionsState}  Name='noDisplay' coin='polygon3' />
    <Winners className={states.winnersState} Name='noDisplay' coin='polygon3'/> 
