...
import { abi, abi1, contractAddresses4,} from "../constants";
...
const Polygon5 = () => {
 ...
 const [states, dispatch] = useReducer(reducer, initialState)
  ...
  const raffleAddress =
    chainId in contractAddresses4 ? contractAddresses4[chainId][0] : null;
  ...
  async function updateUIValues() {
    ...
    const price1 = (Math.round((500/price)*10**18)).toString()
  ...
  return (
    <div className="eth__page">
     ...
     <Details className={states.detailsState} coin='polygon5' />
    <Calendar className={states.calendarState} Name='noDisplay' coin='polygon5' />
    <Transactions className={states.transactionsState}  Name='noDisplay' coin='polygon5' />
    <Winners className={states.winnersState} Name='noDisplay' coin='polygon5'/> 
