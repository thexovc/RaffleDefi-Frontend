...
import { abi, abi1, contractAddresses3,} from "../constants";
...
const Polygon4 = () => {
 ...
 const [states, dispatch] = useReducer(reducer, initialState)
  ...
  const raffleAddress =
    chainId in contractAddresses3 ? contractAddresses3[chainId][0] : null;
  ...
  async function updateUIValues() {
    ...
    const price1 = (Math.round((100/price)*10**18)).toString()
  ...
  return (
    <div className="eth__page">
     ...
     <Details className={states.detailsState} coin='polygon4' />
    <Calendar className={states.calendarState} Name='noDisplay' coin='polygon4' />
    <Transactions className={states.transactionsState}  Name='noDisplay' coin='polygon4' />
    <Winners className={states.winnersState} Name='noDisplay' coin='polygon4'/> 
