...
import { abi, abi1, contractAddresses1,} from "../constants";
...
const Polygon2 = () => {
 ...
 const [states, dispatch] = useReducer(reducer, initialState)
  ...
  const raffleAddress =
    chainId in contractAddresses1 ? contractAddresses1[chainId][0] : null;
  ...
  async function updateUIValues() {
    ...
    const price1 = (Math.round((10/price)*10**18)).toString()
  ...
  return (
    <div className="eth__page">
     ...
     <Details className={states.detailsState} coin='polygon2' />
    <Calendar className={states.calendarState} Name='noDisplay' coin='polygon2' />
    <Transactions className={states.transactionsState}  Name='noDisplay' coin='polygon2' />
    <Winners className={states.winnersState} Name='noDisplay' coin='polygon2'/> 
